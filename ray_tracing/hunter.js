...
// red sphere
var redShape = new Sphere(
    new Vector3(0, spherePos + 14, sphereSize), // center
    4, // radius
    new Material(
        new Vector3(1.0, 0.0, 0.0), // color
        0, // reflection
...
// yellow sphere
var yellowShape = new Sphere(
    new Vector3(0, spherePos + 7, sphereSize), // center
    4, // radius
    new Material(
...
// green sphere
var greenShape = new Sphere(
    new Vector3(0, spherePos, sphereSize), // center
    4, // radius
    new Material(
...
// render lights
scene.add(redShape); // red sphere
scene.add(yellowShape); // yellow sphere
scene.add(greenShape); // green sphere
...
//Light #1
var lightHW = new Sphere(
    new Vector3(360, 180, -90), // center
    1, // radius
    new Material(
        new Vector3(), // color
        0, // reflection
...
// scene.add(sphere1);
// scene.add(light1);
scene.add(lightHW); // back light #1
scene.add(lightHW2); // back light #2
// END HOMEWORK
