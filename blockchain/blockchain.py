...
block.new_transaction('Dar', 'Koto & Poto', '2 ETH')
# STEP 4 add the new block to the chain using the new_block() by passing a proof argument for each
block.new_block(proof1)
# STEP 5 Print the chain with the new changes
print("Chain with Transaction #1: ")
print(block.chain)
print("\n")
# STEP 6 Repeat steps 3-5 to record two more transactions
block.new_transaction('McCloud', "Ramirez", '1 ETH')
block.new_block(proof2)
print("Chain with Transaction #2: ")
print(block.chain)
print("\n")

block.new_transaction('Maverick', "Iceman", '0.075 ETH')
block.new_block(proof3)
print("Chain with Transaction #3: ")
print(block.chain)
